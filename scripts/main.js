...
function getElements(){
    var textarea = document.getElementById('html-window');
    textarea.value = 'test';
...
// $(function() {
//     var infobox = alert("This tool will help you build a data pic. You have to use HTML and CSS coding to put your own data pic together. Look out for hints and advice as you work through the instructions.");
// });

// document.getElementById('iframe-preview').contentWindow.document.getElementById('ns_title');
    // var iframe = document.getElementById('iframe-preview').contentWindow.document.getElementById('ns_title');
    // iframe.addEventListener("showAnnotation()", function(event) {

    // })
    // var show = x.style.display= 'block';
    // console.log(show);
...
$(document).on('keyup', function(){
     get_h2 = $("#iframe-preview").contents().find('#ns_title').text();
     get_h2.css = ("background-color","yellow");
     get_h3.css = ("background-color","black");
